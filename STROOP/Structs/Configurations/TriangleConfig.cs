namespace STROOP.Structs.Configurations
{
    public static class TriangleConfig
    {
        ...
        public static uint TriangleListPointerAddress
        {
            get => RomVersionConfig.SwitchMap(TriangleListPointerAddressUS, TriangleListPointerAddressJP);
        }
        ...
        public static uint LevelTriangleCountAddress
        {
            get => RomVersionConfig.SwitchMap(LevelTriangleCountAddressUS, LevelTriangleCountAddressJP, LevelTriangleCountAddressSH);
        }
        ...
        public static uint TotalTriangleCountAddress
        {
            get => RomVersionConfig.SwitchMap(TotalTriangleCountAddressUS, TotalTriangleCountAddressJP, TotalTriangleCountAddressSH);
        }
        ...
        public static uint NodeListPointerAddress
        {
            get => RomVersionConfig.SwitchMap(NodeListPointerAddressUS, NodeListPointerAddressJP);
        }
        ...
        public static uint LevelNodeCountAddress
        {
            get => RomVersionConfig.SwitchMap(LevelNodeCountAddressUS, LevelNodeCountAddressJP);
        }
        ...
        public static uint TotalNodeCountAddress
        {
            get => RomVersionConfig.SwitchMap(TotalNodeCountAddressUS, TotalNodeCountAddressJP);
        }
        ...
        public static uint ExertionForceTableAddress
        {
            get => RomVersionConfig.SwitchMap(ExertionForceTableAddressUS, ExertionForceTableAddressJP);
        }
        ...
        public static uint StaticTrianglePartitionAddress
        {
            get => RomVersionConfig.SwitchMap(StaticTrianglePartitionAddressUS, StaticTrianglePartitionAddressJP);
        }
        ...
        public static uint DynamicTrianglePartitionAddress
        {
            get => RomVersionConfig.SwitchMap(DynamicTrianglePartitionAddressUS, DynamicTrianglePartitionAddressJP);
        }

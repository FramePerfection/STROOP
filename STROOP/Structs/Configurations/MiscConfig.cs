...
namespace STROOP.Structs
{
    ...
    {
        public static uint WarpDestinationAddress
        {
            get => RomVersionConfig.SwitchMap(WarpDestinationAddressUS, WarpDestinationAddressJP, WarpDestinationAddressSH, WarpDestinationAddressEU);
        }
        ...
        {
            get => RomVersionConfig.SwitchMap(LoadingPointAddressUS, LoadingPointAddressJP, LoadingPointAddressSH, LoadingPointAddressEU);
        }
        ...
        {
            get => RomVersionConfig.SwitchMap(MissionAddressUS, MissionAddressJP, MissionAddressSH, MissionAddressEU);
        }
        ...
        public static uint LevelIndexAddress
        {
            get => RomVersionConfig.SwitchMap(LevelIndexAddressUS, LevelIndexAddressJP, LevelIndexAddressSH, LevelIndexAddressEU);
        }
        ...
        public static uint WaterLevelMedianAddress
        {
            get => RomVersionConfig.SwitchMap(WaterLevelMedianAddressUS, WaterLevelMedianAddressJP, WaterLevelMedianAddressSH, WaterLevelMedianAddressEU);
        }
        ...
        public static uint WaterPointerAddress
        {
            get => RomVersionConfig.SwitchMap(WaterPointerAddressUS, WaterPointerAddressJP, null, WaterPointerAddressEU);
        }
        ...
        public static uint CurrentFileAddress
        {
            get => RomVersionConfig.SwitchMap(CurrentFileAddressUS, CurrentFileAddressJP, CurrentFileAddressSH, CurrentFileAddressEU);
        }
        ...
        public static uint SpecialTripleJumpAddress
        {
            get => RomVersionConfig.SwitchMap(SpecialTripleJumpAddressUS, SpecialTripleJumpAddressJP, SpecialTripleJumpAddressEU);
        }
        ...
        {
            get => RomVersionConfig.SwitchMap(HackedAreaAddressUS, HackedAreaAddressJP, HackedAreaAddressSH, HackedAreaAddressEU);
        }
        ...
        {
            get => RomVersionConfig.SwitchMap(GlobalTimerAddressUS, GlobalTimerAddressJP, GlobalTimerAddressSH, GlobalTimerAddressEU);
        }
        ...
        {
            get => RomVersionConfig.SwitchMap(RngAddressUS, RngAddressJP, RngAddressSH, RngAddressEU);
        }
        ...
        {
            get => RomVersionConfig.SwitchMap(AnimationTimerAddressUS, AnimationTimerAddressJP, null, AnimationTimerAddressEU);
        }
        ...
        public static uint MusicOnAddress
        {
            get => RomVersionConfig.SwitchMap(MusicOnAddressUS, MusicOnAddressJP, null, MusicOnAddressEU);
        }
        ...
        public static uint MusicVolumeAddress
        {
            get => RomVersionConfig.SwitchMap(MusicVolumeAddressUS, MusicVolumeAddressJP, null, MusicVolumeAddressEU);
        }
        ...
        public static uint DemoCounterAddress
        {
            get => RomVersionConfig.SwitchMap(DemoCounterAddressUS, DemoCounterAddressJP, null, DemoCounterAddressEU);
        }
        ...
        public static uint TtcSpeedSettingAddress
        {
            get => RomVersionConfig.SwitchMap(TtcSpeedSettingAddressUS, TtcSpeedSettingAddressJP, null, TtcSpeedSettingAddressEU);
        }
        ...
        public static uint GfxBufferStartAddress
        {
            get => RomVersionConfig.SwitchMap(GfxBufferStartAddressUS, GfxBufferStartAddressJP);
        }
        ...
        public static uint GfxBufferEndAddress
        {
            get => RomVersionConfig.SwitchMap(GfxBufferEndAddressUS, GfxBufferEndAddressJP);
        }

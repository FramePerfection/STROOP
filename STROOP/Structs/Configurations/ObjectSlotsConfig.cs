...
namespace STROOP.Structs
{
    public static class ObjectSlotsConfig
    {
        ...
        public static uint ProcessGroupsStartAddress
        {
            get => RomVersionConfig.SwitchMap(ProcessGroupsStartAddressUS, ProcessGroupsStartAddressJP, ProcessGroupsStartAddressSH, ProcessGroupsStartAddressEU);
        }
        ...
        public static uint ObjectSlotsStartAddress
        {
            get => RomVersionConfig.SwitchMap(ObjectSlotsStartAddressUS, ObjectSlotsStartAddressJP, ObjectSlotsStartAddressSH, ObjectSlotsStartAddressEU);
        }
        ...
        public static uint VacantSlotsNodeAddress
        {
            get => RomVersionConfig.SwitchMap(VacantSlotsNodeAddressUS, VacantSlotsNodeAddressJP, VacantSlotsNodeAddressSH, VacantSlotsNodeAddressEU);
        }
        ...
        public static uint UnusedSlotAddress
        {
            get => RomVersionConfig.SwitchMap(UnusedSlotAddressUS, UnusedSlotAddressJP, UnusedSlotAddressSH, UnusedSlotAddressEU);
        }

...
namespace STROOP.Structs.Configurations
{
    public static class AreaConfig
    {
        ...
        public static uint CurrentAreaPointerAddress
        {
            get => RomVersionConfig.SwitchMap(CurrentAreaPointerAddressUS, CurrentAreaPointerAddressJP, 0, CurrentAreaPointerAddressEU);
        }

namespace STROOP.Structs.Configurations
{
    public static class HudConfig
    {
        ...
        public static uint FunctionEnableCoinDisplayAddress
        {
            get => RomVersionConfig.SwitchMap(FunctionEnableCoinDisplayAddressUS, FunctionEnableCoinDisplayAddressJP);
        }
        ...
        public static uint FunctionDisableCoinDisplayAddress
        {
            get => RomVersionConfig.SwitchMap(FunctionDisableCoinDisplayAddressUS, FunctionDisableCoinDisplayAddressJP);
        }

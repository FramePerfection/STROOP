...
public static class MarioConfig
{
    ...
    public static uint StoodOnObjectPointerAddress => RomVersionConfig.SwitchMap(StoodOnObjectPointerAddressUS, StoodOnObjectPointerAddressJP, StoodOnObjectPointerAddressSH, StoodOnObjectPointerAddressEU);

...
namespace STROOP.Variables.SM64MemoryLayout
{
    public static class CameraConfig
    {
        ...
        public static uint FOVStructAddress
        {
            get => RomVersionConfig.SwitchMap(FOVStructAddressUS, FOVStructAddressJP, null, FOVStructAddressEU);
        }
        ...
        public static uint SecondaryObjectAddress
        {
            get => RomVersionConfig.SwitchMap(SecondaryObjectAddressUS, SecondaryObjectAddressJP, null, SecondaryObjectAddressEU);
        }
        ...
        public static uint FovFunctionAwakeAddress
        {
            get => RomVersionConfig.SwitchMap(FovFunctionAwakeAddressUS, FovFunctionAwakeAddressJP, null, FovFunctionAwakeAddressEU);
        }
        ...
        public static uint FovFunctionSleepingAddress
        {
            get => RomVersionConfig.SwitchMap(FovFunctionSleepingAddressUS, FovFunctionSleepingAddressJP, null, FovFunctionSleepingAddressEU);
        }
        ...
        public static uint FovFunctionUseDoorAddress
        {
            get => RomVersionConfig.SwitchMap(FovFunctionUseDoorAddressUS, FovFunctionUseDoorAddressJP, null, FovFunctionUseDoorAddressEU);
        }
        ...
        public static uint FovFunctionCollectStarAddress
        {
            get => RomVersionConfig.SwitchMap(FovFunctionCollectStarAddressUS, FovFunctionCollectStarAddressJP, null, FovFunctionCollectStarAddressEU);
        }
        ...
        public static uint FovFunctionAwakeValue
        {
            get => RomVersionConfig.SwitchMap(FovFunctionAwakeValueUS, FovFunctionAwakeValueJP);
        }
        ...
        public static uint FovFunctionSleepingValue
        {
            get => RomVersionConfig.SwitchMap(FovFunctionSleepingValueUS, FovFunctionSleepingValueJP);
        }
        ...
        public static uint FovFunctionUseDoorValue
        {
            get => RomVersionConfig.SwitchMap(FovFunctionUseDoorValueUS, FovFunctionUseDoorValueJP);
        }
        ...
        public static uint FovFunctionCollectStarValue
        {
            get => RomVersionConfig.SwitchMap(FovFunctionCollectStarValueUS, FovFunctionCollectStarValueJP);
        }

...
{
    public static uint StructAddress => RomVersionConfig.SwitchMap(StructAddressUS, StructAddressJP, StructAddressSH, StructAddressEU);
    ...
    public static uint CamStructAddress => ProcessStream.Instance.GetUInt32(RomVersionConfig.SwitchMap(0x8033cbd0, 0x8033b860));
    ...
    public static uint FOVStructAddress => RomVersionConfig.SwitchMap(FOVStructAddressUS, FOVStructAddressJP, null, FOVStructAddressEU);
    ...
    public static uint SecondaryObjectAddress => RomVersionConfig.SwitchMap(SecondaryObjectAddressUS, SecondaryObjectAddressJP, null, SecondaryObjectAddressEU);
    ...
    public static uint FovFunctionAwakeAddress => RomVersionConfig.SwitchMap(FovFunctionAwakeAddressUS, FovFunctionAwakeAddressJP, null, FovFunctionAwakeAddressEU);
    ...
    public static uint FovFunctionSleepingAddress => RomVersionConfig.SwitchMap(FovFunctionSleepingAddressUS, FovFunctionSleepingAddressJP, null, FovFunctionSleepingAddressEU);
    ...
    public static uint FovFunctionUseDoorAddress => RomVersionConfig.SwitchMap(FovFunctionUseDoorAddressUS, FovFunctionUseDoorAddressJP, null, FovFunctionUseDoorAddressEU);
    ...
    public static uint FovFunctionCollectStarAddress => RomVersionConfig.SwitchMap(FovFunctionCollectStarAddressUS, FovFunctionCollectStarAddressJP, null, FovFunctionCollectStarAddressEU);
    ...
    public static uint FovFunctionAwakeValue => RomVersionConfig.SwitchMap(FovFunctionAwakeValueUS, FovFunctionAwakeValueJP);
    ...
    public static uint FovFunctionSleepingValue => RomVersionConfig.SwitchMap(FovFunctionSleepingValueUS, FovFunctionSleepingValueJP);
    ...
    public static uint FovFunctionUseDoorValue => RomVersionConfig.SwitchMap(FovFunctionUseDoorValueUS, FovFunctionUseDoorValueJP);
    ...
    public static uint FovFunctionCollectStarValue => RomVersionConfig.SwitchMap(FovFunctionCollectStarValueUS, FovFunctionCollectStarValueJP);
    ...
    public static List<uint> FovFunctionAddresses => new List<uint>()
    {
    ...
    public static List<uint> FovFunctionValues => new List<uint>()
    {

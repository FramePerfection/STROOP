...
namespace STROOP.Variables.Utilities
{
    public static class ColorUtilities
    {
        ...
        public static Color GetColorForVariable(int? inputtedNumber)
        {
        ...
        public static Color? GetColorForHighlight(int? inputtedNumber)
        {
        ...
        public static Color? ConvertDecimalToColor(List<int?> numbersNullable)
        {

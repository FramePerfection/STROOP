...
public static class TypeUtilities
{
    ...
    public static readonly Dictionary<Type, string> TypeToString = new Dictionary<Type, string>()
    {
        { typeof(byte), "byte" },
        { typeof(sbyte), "sbyte" },
        { typeof(short), "short" },
    ...
    public static readonly Dictionary<Type, int> TypeSize = new Dictionary<Type, int>()
    {
        { typeof(byte), 1 },
        { typeof(sbyte), 1 },
        { typeof(short), 2 },
    ...
    public static readonly Dictionary<Type, bool> TypeSign = new Dictionary<Type, bool>()
    {
        { typeof(byte), false },
        { typeof(sbyte), true },
        { typeof(short), true },
    ...
    public static readonly Dictionary<int, Type> UnsignedByteType = new Dictionary<int, Type>()
    {
        { 1, typeof(byte) },
        { 2, typeof(ushort) },
        { 4, typeof(uint) },
    ...
    public static readonly List<string> SimpleTypeList =
        new List<string>()
        {
            "byte",
            "sbyte",
    ...
    public static readonly List<string> InGameTypeList =
        new List<string>()
        {
            "byte",
            "sbyte",
    ...
    public static bool IsNumber(object obj) => obj is byte ||
                                               obj is sbyte ||
                                               obj is short ||
                                               obj is ushort ||
                                               obj is int ||
    ...
    public static bool IsIntegerNumber(object obj) => obj is byte ||
                                                      obj is sbyte ||
                                                      obj is short ||
                                                      obj is ushort ||
                                                      obj is int ||
    ...
    public static bool IsSubtype(Type type1, Type type2) => type1 == type2 || type1.IsSubclassOf(type2);
